...
connect_bd_intf_net -intf_net [get_bd_intf_nets test_app_base_0_data_out] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS] [get_bd_intf_pins test_application/data_out]
  ...
  connect_bd_net -net cancel_pmbus_1 [get_bd_pins pmbus/cancel_pmbus] [get_bd_pins test_manager/cancel_pmbus]
  ...
  connect_bd_net -net i2c_clock_select_1 [get_bd_pins pmbus/i2c_clock_select] [get_bd_pins test_application/i2cClockSelect]
