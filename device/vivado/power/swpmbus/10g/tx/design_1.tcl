...
proc create_hier_cell_test_manager { parentCell nameHier } {
  ...
  connect_bd_net -net aresetn_1 [get_bd_pins ap_rst_n] [get_bd_pins axis_clock_converter_0/m_axis_aresetn] [get_bd_pins axis_clock_converter_1/s_axis_aresetn] [get_bd_pins clk_counter_0/rstn2]
...
proc create_hier_cell_test_application { parentCell nameHier } {
  ...
  # Create instance: xlconstant_val_0_32bit, and set properties
  set xlconstant_val_0_32bit [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 xlconstant_val_0_32bit ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
   CONFIG.CONST_WIDTH {32} \
 ] $xlconstant_val_0_32bit
  ...
  connect_bd_intf_net -intf_net ber_test_manager_0_cmd [get_bd_intf_pins pmbus_cmd_out] [get_bd_intf_pins axis_clock_converter_0/M_AXIS]
  connect_bd_intf_net -intf_net ber_test_manager_0_cmd_out [get_bd_intf_pins cmd_in] [get_bd_intf_pins test_app_base_0/cmd_in]
  set_property SIM_ATTRIBUTE.MARK_SIM "true" [get_bd_intf_nets /test_application/ber_test_manager_0_cmd_out]
  ...
  set_property SIM_ATTRIBUTE.MARK_SIM "true" [get_bd_intf_nets /test_application/test_app_base_0_ack_out]
  ...
  connect_bd_net -net aresetn_1 [get_bd_pins ap_rst_n] [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins axis_clock_converter_1/m_axis_aresetn] [get_bd_pins axis_counter_0/resetn] [get_bd_pins test_app_base_0/ap_rst_n]
  ...
  connect_bd_net -net xlconstant_val_0_32bit_dout [get_bd_pins test_app_base_0/latency_result] [get_bd_pins xlconstant_val_0_32bit/dout]
  connect_bd_net -net xlconstant_val_1_dout [get_bd_pins test_app_base_0/ap_start] [get_bd_pins test_app_base_0/cnt_in_TVALID] [get_bd_pins test_app_base_0/reset_modules_out_TREADY] [get_bd_pins xlconstant_val_1/dout]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
connect_bd_intf_net -intf_net Conn [get_bd_intf_pins system_ila_0/SLOT_5_AXIS] [get_bd_intf_pins test_application/counter_val_in]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ber_test_manager_0_cmd_out] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS] [get_bd_intf_pins test_application/cmd_in]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets ber_test_manager_0_cmd_out]
  set_property SIM_ATTRIBUTE.MARK_SIM "true" [get_bd_intf_nets /ber_test_manager_0_cmd_out]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets comma_injector_0_ctrl_out] [get_bd_intf_ports ctrl_out] [get_bd_intf_pins system_ila_0/SLOT_4_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets comma_injector_0_data_out] [get_bd_intf_ports data_out] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets test_app_base_0_ack_out] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS] [get_bd_intf_pins test_manager/ack_in]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets test_app_base_0_ack_out]
  set_property SIM_ATTRIBUTE.MARK_SIM "true" [get_bd_intf_nets /test_app_base_0_ack_out]
  connect_bd_intf_net -intf_net test_app_base_0_data_out [get_bd_intf_pins comma_injector_0/data_in] [get_bd_intf_pins test_application/data_out]
connect_bd_intf_net -intf_net [get_bd_intf_nets test_app_base_0_data_out] [get_bd_intf_pins comma_injector_0/data_in] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets test_app_base_0_data_out]
  connect_bd_intf_net -intf_net test_application_pmbus_cmd_out [get_bd_intf_pins pmbus/s_axis_cmd] [get_bd_intf_pins test_application/pmbus_cmd_out]
  ...
  connect_bd_net -net Reset_1 [get_bd_pins pmbus/Reset] [get_bd_pins proc_sys_reset_0/mb_reset]
  connect_bd_net -net aclk_1 [get_bd_ports aclk] [get_bd_pins c_counter_binary_1/CLK] [get_bd_pins comma_injector_0/ap_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins test_application/ap_clk] [get_bd_pins test_manager/ap_clk]
  connect_bd_net -net aresetn_1 [get_bd_ports aresetn] [get_bd_pins comma_injector_0/ap_rst_n] [get_bd_pins system_ila_0/resetn] [get_bd_pins test_application/ap_rst_n] [get_bd_pins test_manager/ap_rst_n]
  connect_bd_net -net bus_rst_1 [get_bd_pins pmbus/bus_rst] [get_bd_pins proc_sys_reset_0/bus_struct_reset]
  ...
  connect_bd_net -net pmbus_mb_debug_sys_rst [get_bd_pins pmbus/mb_debug_sys_rst] [get_bd_pins proc_sys_reset_0/mb_debug_sys_rst]
  ...
  connect_bd_net -net test_application_i2cClockSelect [get_bd_pins pmbus/i2c_clock_select] [get_bd_pins test_application/i2cClockSelect]
  connect_bd_net -net test_manager_cancel_pmbus [get_bd_pins pmbus/cancel_pmbus] [get_bd_pins test_manager/cancel_pmbus]
  connect_bd_net -net test_manager_cancel_test [get_bd_pins test_application/cancel_test] [get_bd_pins test_manager/cancel_test]
  connect_bd_net -net xlconstant_val_1_dout [get_bd_pins comma_injector_0/ap_start] [get_bd_pins xlconstant_val_1/dout]
