...
# module references:
# pmbus_io, axis_counter, sync_reg, ap_start_only_once, clk_counter, sync_reg
...
Fixstars:hls:comma_injector:1.0\
...
proc create_hier_cell_test_manager { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_pins ap_clk] [get_bd_pins axis_clock_converter_0/m_axis_aclk] [get_bd_pins axis_clock_converter_1/s_axis_aclk] [get_bd_pins clk_counter_0/clk2] [get_bd_pins sync_reg_0/clk]
  connect_bd_net -net ap_rst_n [get_bd_pins ap_rst_n] [get_bd_pins axis_clock_converter_0/m_axis_aresetn] [get_bd_pins axis_clock_converter_1/s_axis_aresetn] [get_bd_pins clk_counter_0/rstn2]
...
proc create_hier_cell_pmbus { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets Conn2] [get_bd_intf_pins m_axis_ack] [get_bd_intf_pins system_ila_1/SLOT_2_AXIS]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets microblaze_0_M0_AXIS] [get_bd_intf_pins microblaze_0/M0_AXIS] [get_bd_intf_pins system_ila_1/SLOT_1_AXIS]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins ap_clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_local_memory/clk_out1] [get_bd_pins smartconnect_0/aclk] [get_bd_pins system_ila_1/clk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins ap_rst_n] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins system_ila_1/resetn]
...
proc create_root_design { parentCell } {
  ...
  set ctrl_out [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 ctrl_out ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {125000000} \
   ] $ctrl_out
  ...
  set data_out [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 data_out ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {125000000} \
   ] $data_out
  ...
  set led_ext_clk [ create_bd_port -dir O -from 0 -to 0 led_ext_clk ]
  ...
  set rx_aclk [ create_bd_port -dir I -type clk -freq_hz 125000000 rx_aclk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {ctrl_in:data_in} \
   CONFIG.ASSOCIATED_RESET {rx_aresetn} \
 ] $rx_aclk
  set rx_aresetn [ create_bd_port -dir I -type rst rx_aresetn ]
  ...
  set tx_aclk [ create_bd_port -dir I -type clk -freq_hz 125000000 tx_aclk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {data_out:ctrl_out} \
   CONFIG.ASSOCIATED_RESET {tx_aresetn} \
 ] $tx_aclk
  set tx_aresetn [ create_bd_port -dir I -type rst tx_aresetn ]
  ...
  # Create instance: comma_injector_0, and set properties
  set comma_injector_0 [ create_bd_cell -type ip -vlnv Fixstars:hls:comma_injector:1.0 comma_injector_0 ]
  ...
  # Create instance: tx_proc_sys_reset, and set properties
  set tx_proc_sys_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 tx_proc_sys_reset ]

  # Create instance: tx_system_ila, and set properties
  set tx_system_ila [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila:1.1 tx_system_ila ]
  set_property -dict [ list \
   CONFIG.C_MON_TYPE {INTERFACE} \
   CONFIG.C_NUM_MONITOR_SLOTS {3} \
  ...
  # Create interface connections
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins system_ila_0/SLOT_7_AXIS] [get_bd_intf_pins test_application/counter_val_in]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins comma_injector_0/data_in]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_data_fifo_0_M_AXIS] [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins tx_system_ila/SLOT_0_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_data_fifo_0_M_AXIS]
  connect_bd_intf_net -intf_net axis_data_fifo_1_M_AXIS [get_bd_intf_pins axis_data_fifo_1/M_AXIS] [get_bd_intf_pins data_checker_0/exp_in]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ber_test_manager_0_cmd_out] [get_bd_intf_pins system_ila_0/SLOT_4_AXIS] [get_bd_intf_pins test_application/cmd_in]
  ...
  connect_bd_intf_net -intf_net comma_injector_0_ctrl_out [get_bd_intf_ports ctrl_out] [get_bd_intf_pins comma_injector_0/ctrl_out]
connect_bd_intf_net -intf_net [get_bd_intf_nets comma_injector_0_ctrl_out] [get_bd_intf_ports ctrl_out] [get_bd_intf_pins tx_system_ila/SLOT_2_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets comma_injector_0_ctrl_out]
  connect_bd_intf_net -intf_net comma_injector_0_data_out [get_bd_intf_ports data_out] [get_bd_intf_pins comma_injector_0/data_out]
connect_bd_intf_net -intf_net [get_bd_intf_nets comma_injector_0_data_out] [get_bd_intf_ports data_out] [get_bd_intf_pins tx_system_ila/SLOT_1_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets comma_injector_0_data_out]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets test_app_base_0_ack_out] [get_bd_intf_pins system_ila_0/SLOT_5_AXIS] [get_bd_intf_pins test_manager/ack_in]
  ...
  connect_bd_intf_net -intf_net test_app_base_0_data_out [get_bd_intf_pins axis_broadcaster_0/S_AXIS] [get_bd_intf_pins test_application/data_out]
connect_bd_intf_net -intf_net [get_bd_intf_nets test_app_base_0_data_out] [get_bd_intf_pins axis_broadcaster_0/S_AXIS] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS]
  ...
  connect_bd_net -net aclk_1 [get_bd_ports rx_aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins data_aligner_0/ap_clk] [get_bd_pins data_checker_0/ap_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins test_application/ap_clk] [get_bd_pins test_manager/ap_clk]
  connect_bd_net -net aresetn_1 [get_bd_ports rx_aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins test_application/ap_rst_n] [get_bd_pins test_manager/ap_rst_n]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins c_counter_binary_0/Q] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net c_counter_binary_0_Q1 [get_bd_pins c_counter_binary_1/Q] [get_bd_pins xlslice_1/Din]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_ports ap_clk_jtag] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins pmbus/ap_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins test_application/ap_clk_pmbus] [get_bd_pins test_manager/ap_clk_jtag]
  connect_bd_net -net pmbus_Debug_SYS_Rst [get_bd_pins pmbus/mb_debug_sys_rst] [get_bd_pins proc_sys_reset_0/mb_debug_sys_rst]
  connect_bd_net -net proc_sys_reset_0_bus_struct_reset [get_bd_pins pmbus/bus_rst] [get_bd_pins proc_sys_reset_0/bus_struct_reset]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins pmbus/int_rst_n] [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins test_application/ap_rst_n_pmbus]
  connect_bd_net -net proc_sys_reset_0_mb_reset [get_bd_pins pmbus/Reset] [get_bd_pins proc_sys_reset_0/mb_reset]
  ...
  connect_bd_net -net tx_aclk_1 [get_bd_ports tx_aclk] [get_bd_pins axis_data_fifo_0/m_axis_aclk] [get_bd_pins c_counter_binary_1/CLK] [get_bd_pins comma_injector_0/ap_clk] [get_bd_pins tx_proc_sys_reset/slowest_sync_clk] [get_bd_pins tx_system_ila/clk]
  connect_bd_net -net tx_aresetn_1 [get_bd_ports tx_aresetn] [get_bd_pins tx_proc_sys_reset/aux_reset_in]
  connect_bd_net -net tx_proc_sys_reset_peripheral_aresetn [get_bd_pins comma_injector_0/ap_rst_n] [get_bd_pins tx_proc_sys_reset/peripheral_aresetn] [get_bd_pins tx_system_ila/resetn]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_ports reset_latency] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins data_aligner_0/ap_rst_n] [get_bd_pins data_checker_0/ap_rst_n] [get_bd_pins system_ila_0/probe1] [get_bd_pins test_application/reset_modules] [get_bd_pins tx_proc_sys_reset/ext_reset_in]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets util_vector_logic_1_Res]
  connect_bd_net -net xlconstant_val_1_dout [get_bd_pins comma_injector_0/ap_start] [get_bd_pins data_aligner_0/ap_start] [get_bd_pins data_checker_0/ap_start] [get_bd_pins xlconstant_val_1/dout]
