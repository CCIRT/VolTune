...
This directory contains RX design with transceivers set to 10 Gbps.  
This design is for testing that measuring Bit Error Rate, Latency and Power.

## Block diagram

This is RX side design.
...
--> ReadDataCtrl("Read\nData and Ctrl")
--> CtrlIsValid{"Ctrl\n!= 0x0 ?"}
--> | Yes | CheckShiftValue{"Check\nShift Value"}
--> | OK | ReadDataCtrl2("Read\nData and Ctrl")
--> CtrlIsValid2{"Ctrl\n!= 0x0 ?"}
--> | Yes | OutputLastData("Output Last Data\n(if exist)")
--> End(( ))
...
CtrlIsValid2
--> | No | OutputData("Output Shifted Data")
--> ReadDataCtrl2
```
...
| 0x0000_2020 | [63:0] | R    | latency        | Cycle count between send first data to receive first data. |
