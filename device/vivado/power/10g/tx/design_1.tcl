...
proc create_hier_cell_pmbus { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type clk ap_clk
  create_bd_pin -dir I -type rst ap_rest_n
  ...
  if { [catch {set axis_pmbus_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property -dict [ list \
   CONFIG.CLOCK_DIV_WIDTH {9} \
   CONFIG.DIV200kHz {499} \
   CONFIG.DIV2MHz {49} \
   CONFIG.DIV800kHz {124} \
 ] $axis_pmbus_wrapper_0
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins ap_rest_n] [get_bd_pins axis_counter_0/resetn] [get_bd_pins axis_pmbus_wrapper_0/resetn] [get_bd_pins power_manager_0/ap_rst_n] [get_bd_pins system_ila_1/resetn]
...
connect_bd_intf_net -intf_net Conn [get_bd_intf_pins system_ila_0/SLOT_5_AXIS] [get_bd_intf_pins test_application/counter_val_in]
  connect_bd_intf_net -intf_net ber_test_manager_0_cmd [get_bd_intf_pins pmbus/s_axis_cmd] [get_bd_intf_pins test_application/pmbus_cmd_out]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets ber_test_manager_0_cmd]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets test_app_base_0_data_out] [get_bd_intf_pins comma_injector_0/data_in] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins pmbus/ap_rest_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins test_manager/ap_rst_n_jtag]
