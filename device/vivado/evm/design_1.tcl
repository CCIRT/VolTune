...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ack [get_bd_intf_pins power_manager_0/m_axis_ack] [get_bd_intf_pins voltage_test_manager_0/s_axis_ack]
connect_bd_intf_net -intf_net [get_bd_intf_nets ack] [get_bd_intf_pins power_manager_0/m_axis_ack] [get_bd_intf_pins system_ila_0/SLOT_4_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets ack]
  connect_bd_intf_net -intf_net cmd [get_bd_intf_pins power_manager_0/s_axis_cmd] [get_bd_intf_pins voltage_test_manager_0/m_axis_cmd]
connect_bd_intf_net -intf_net [get_bd_intf_nets cmd] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS] [get_bd_intf_pins voltage_test_manager_0/m_axis_cmd]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets cmd]
  connect_bd_intf_net -intf_net counter [get_bd_intf_pins axis_counter_0/m_axis_cnt] [get_bd_intf_pins voltage_test_manager_0/s_axis_counter]
connect_bd_intf_net -intf_net [get_bd_intf_nets counter] [get_bd_intf_pins axis_counter_0/m_axis_cnt] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets counter]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets pmbus_ack] [get_bd_intf_pins axis_pmbus_wrapper_0/m_axis] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets pmbus_cmd] [get_bd_intf_pins power_manager_0/m_axis_pmbus_cmd] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets pmbus_cmd]
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins smartconnect_0/M00_AXI] [get_bd_intf_pins voltage_test_manager_0/s_axi_regs]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets voltage_test_manager_0_m_axis_led] [get_bd_intf_pins system_ila_0/SLOT_5_AXIS] [get_bd_intf_pins voltage_test_manager_0/m_axis_led]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets voltage_test_manager_0_m_axis_led]
  ...
  connect_bd_net -net clkSelect [get_bd_pins axis_pmbus_wrapper_0/i2c_clock_select] [get_bd_pins system_ila_0/probe0] [get_bd_pins voltage_test_manager_0/i2cClockSelect]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets clkSelect]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axis_counter_0/clock] [get_bd_pins axis_led_adaptor_0/clock] [get_bd_pins axis_pmbus_wrapper_0/clock] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins coraz707s_led_0/clock] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins power_manager_0/ap_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins system_ila_0/clk] [get_bd_pins voltage_test_manager_0/ap_clk]
  ...
  connect_bd_net -net failLED [get_bd_pins axis_led_adaptor_0/failLED] [get_bd_pins coraz707s_led_0/failLED] [get_bd_pins system_ila_0/probe1]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets failLED]
  connect_bd_net -net fatalErrorLED [get_bd_pins axis_led_adaptor_0/fatalErrorLED] [get_bd_pins coraz707s_led_0/fatalErrorLED] [get_bd_pins system_ila_0/probe2]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets fatalErrorLED]
  connect_bd_net -net okLED [get_bd_pins axis_led_adaptor_0/okLED] [get_bd_pins coraz707s_led_0/okLED] [get_bd_pins system_ila_0/probe3]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets okLED]
  connect_bd_net -net power_manager_0_error [get_bd_pins axis_led_adaptor_0/error] [get_bd_pins power_manager_0/error]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axis_counter_0/resetn] [get_bd_pins axis_led_adaptor_0/resetn] [get_bd_pins axis_pmbus_wrapper_0/resetn] [get_bd_pins coraz707s_led_0/resetn] [get_bd_pins jtag_axi_0/aresetn] [get_bd_pins power_manager_0/ap_rst_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins voltage_test_manager_0/ap_rst_n]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins clk_wiz_0/reset] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net runLED [get_bd_pins axis_led_adaptor_0/runLED] [get_bd_pins coraz707s_led_0/runLED] [get_bd_pins system_ila_0/probe4]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets runLED]
