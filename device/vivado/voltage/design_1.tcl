...
# module references:
# axis_counter, axis_led_adaptor, axis_pmbus_wrapper, kc705_led
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net power_manager_0_m_axis_ack [get_bd_intf_pins power_manager_0/m_axis_ack] [get_bd_intf_pins voltage_test_manager_0/s_axis_ack]
  ...
  connect_bd_intf_net -intf_net voltage_test_manager_0_m_axis_cmd [get_bd_intf_pins power_manager_0/s_axis_cmd] [get_bd_intf_pins voltage_test_manager_0/m_axis_cmd]
  ...
  connect_bd_net -net axis_counter_0_counter [get_bd_pins axis_counter_0/counter] [get_bd_pins kc705_led_0/counter] [get_bd_pins kc705_led_0/resetn] [get_bd_pins power_manager_0/counter]
  ...
  connect_bd_net -net clk_wiz_clk_out1 [get_bd_pins axis_counter_0/clock] [get_bd_pins axis_led_adaptor_0/clock] [get_bd_pins axis_pmbus_wrapper_0/clock] [get_bd_pins clk_wiz/clk_out1] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins jtag_axi_0_axi_periph/ACLK] [get_bd_pins jtag_axi_0_axi_periph/M00_ACLK] [get_bd_pins jtag_axi_0_axi_periph/S00_ACLK] [get_bd_pins kc705_led_0/clock] [get_bd_pins power_manager_0/ap_clk] [get_bd_pins rst_clk_wiz_100M/slowest_sync_clk] [get_bd_pins voltage_test_manager_0/ap_clk]
  ...
  connect_bd_net -net rst_clk_wiz_100M_peripheral_aresetn [get_bd_pins axis_counter_0/resetn] [get_bd_pins axis_led_adaptor_0/resetn] [get_bd_pins axis_pmbus_wrapper_0/resetn] [get_bd_pins jtag_axi_0/aresetn] [get_bd_pins jtag_axi_0_axi_periph/ARESETN] [get_bd_pins jtag_axi_0_axi_periph/M00_ARESETN] [get_bd_pins jtag_axi_0_axi_periph/S00_ARESETN] [get_bd_pins power_manager_0/ap_rst_n] [get_bd_pins rst_clk_wiz_100M/peripheral_aresetn] [get_bd_pins voltage_test_manager_0/ap_rst_n]
  connect_bd_net -net voltage_test_manager_0_i2cClockSelect [get_bd_pins axis_pmbus_wrapper_0/i2c_clock_select] [get_bd_pins voltage_test_manager_0/i2cClockSelect]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins power_manager_0/ap_start] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_val_0_dout [get_bd_pins power_manager_0/cancel] [get_bd_pins xlconstant_val_0/dout]
