...
set_property PACKAGE_PIN Y24  [get_ports tx_data_valid_in]
set_property IOSTANDARD LVDS     [get_ports sysclk_p]
set_property IOSTANDARD LVCMOS25 [get_ports tx_data_valid_in]

# Clock constraints
create_clock -period 5.000 [get_ports sysclk_p]
create_clock -period 8.000 [get_ports gt_refclk_p]
set_clock_groups -asynchronous \
  -group [get_clocks -include_generated_clocks sysclk_p] \
  -group [get_clocks -include_generated_clocks gt_refclk_p] \
  -group [get_clocks -include_generated_clocks rx_gt_wrapper_i/gt_i/inst/gt_init_i/gt_i/gt0_gt_i/gtxe2_i/RXOUTCLK]

# Place constraints
set_property LOC GTXE2_CHANNEL_X0Y8 [get_cells rx_gt_wrapper_i/gt_i/inst/gt_init_i/gt_i/gt0_gt_i/gtxe2_i]

# False path
set_false_path -from [get_ports tx_data_valid_in]
